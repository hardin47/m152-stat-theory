...
schedule <- tribble(
  ...
  "Week 1 <br> 1.18.22", 'starting + <br> R + RStudio + <br> Git + GitHub + <br> SLR',"• course info <br> • R + Git <br> • what is a linear model? <br> • least squares <br> • norm errors <br> • tech cond", 
  ...
  '<a href="https://happygitwithr.com/" target = "_blank"><i class="fa fa-comments"></i> happygitwithR</a><br><a href = "https://www.openscapes.org/blog/2022/05/27/github-illustrated-series/" target = "_blank"><i class="fa fa-comments"></i>Why Git? + monsters</a>',
    ...
    "Week 2 <br> 1.25.22", 'Inference',"• Inf on $\\beta_1$ <br> • CI for $\\beta_1$ <br> • CI for mean <br> • PI for indiv<br> •  correlation", 
  ...
  '',
    "Week 3 <br> 2.1.22", 'Diagnositcs',"•  $R^2$ <br> •  F test<br> •  residual plots", 
  ...
  '',
    ...
    "Week 4 <br> 2.8.22", 'Simultaneous <br> Inference + <br> Matrices',"•  $\\beta_0$ & $\\beta_1$<br> •  linear algebra", 
  ...
  '',
    ...
    "Week 5 <br> 2.15.22", 'MLR',"•  indicator terms<br> •  interaction terms<br> •  quadratic terms<br>•  F test <br> •  $R^2$ & $R^2_{adj}$ <br> •  combos of coefs", 
  ...
  '',
      ...
      "Week 6 <br> 2.22.22", 'catch-up',"•  see Sakai for<br> study materials ", 
  '',
  '',
  '',
  ...
  '',
  '',    
  "Week 7 <br> 3.1.22", 'Feature <br> Engineering <br> & CV',"•  **tidymodels** <br> •  feature <br> engineering <br> •  cross validation", 
  ...
  '',
    ...
    "Week 8 <br> 3.8.22", 'Model <br> Building',"•  sums of squares <br> •  nested F-tests <br> •  coef of determination", 
  ...
  '',
  '',      
  "Week 9 <br> 3.22.22", 'Model <br>Building',"•  mulicollinearity <br> •  stepwise <br> procedures ", 
  ...
  '<a href = "https://weallcount.com/2022/03/25/building-compassion-into-your-modelling-variables/" target = "_blank"><i class="fa fa-comments"></i> Compassion + Models</a>',  
    ...
    "Week 10 <br> 3.29.22", 'Diagnostics',"•  residuals <br> •  leverage <br> •  influence", 
  ...
  '',  
    ...
    "Week 11 <br> 4.5.22", 'Ridge Regression',"•  ridge <br> regression", 
  ...
  '',"", 
  '',
     "Week 12 <br> 4.12.22", 'catch-up',"•  see Sakai for <br> study materials", 
  '',
  '',
  '',
  ...
  '',
  '',       
  "Week 13 <br> 4.19.22", 'Lasso',"•  Lasso <br> •  elastic net <br> •  step functions", 
  ...
  '',  
     ...
     "Week 14 <br> 4.26.22", 'Smoothers',"•  ridge regression <br> •  loess ", 
