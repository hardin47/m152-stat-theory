...
schedule <- tribble(
  ...
  '<a href="https://m152-stat-theory.netlify.app/hw/MA152_HW1f22.pdf" target = "_blank"><i class="fa-solid fa-file-pdf"></i> HW1 pdf</a> <br> <a href="hhttps://m152-stat-theory.netlify.app/hw/MA152_HW1f22.Rmd" target = "_blank"><i class="fa-brands fa-r-project"></i> HW1 Rmd</a> <br> <a href="https://m58-intro-stats.netlify.app/github.html" target = "_blank"><i class="fa-solid fa-paper-plane"></i> HW1 turn-in</a>',
  '<a href="" target = "_blank"><i class="fa-solid fa-memo-pad"></i>some handout</a',
  '<a href="https://m152-stat-theory.netlify.app/hw/wu1_ma152_f22.pdf" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 1</a> <br> <a href="https://m152-stat-theory.netlify.app/hw/wu2_ma152_f22.pdf" target = "_blank"><i class="fas fa-pencil-alt"></i> WU 2</a>',
"Week 2 <br> 9.6.22", 
  '• posteriors + <br> • Bayes estimators',
  'P&S: 7.3-7.4 <br> <a href="https://st47s.com/Math152/Notes/bayes.html" target = "_blank"><i class="fas fa-book-open"></i></a>',
  '',
  '',
  '',
