...
* Probability distribution demos: <a href="http://www.stat.cmu.edu/isle/widgets.html" target = "_blank">ISLE widgets</a>
...
Part of the grade will be based on the individual contribution, and part of the grade will be based on the revision.
