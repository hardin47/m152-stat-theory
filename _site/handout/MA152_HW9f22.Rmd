...
Also, show that the unbiased estimator of $\sigma^2$ is not efficient.
...
where the value of $\theta$ is unknown ($\theta > 0$). Determine the asymptotic distribution of the MLE of $\theta$. (Note: The MLE was found in Exercise 9 of Sec. 7.5.)
