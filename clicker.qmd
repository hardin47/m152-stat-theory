...
The values of c1 and c2 which themselves have the **highest posterior probabilities** are:[^39]
    (a) $c_1$ and $c_2$ as the .025 & .975 quantiles
    (b) $c_1$ set to zero
    (c) $c_2$ set to infinity
    (d) $c_1$ and $c_2$ as different quantiles than (a) but that contain .95 probability.
...
40. A 90% CI for the average number of chocolate chips in a Chips Ahoy cookie is:  
[3.7 chips, 17.2 chips]  
What is the correct interpretation?[^40]
    ...
    (c) We are 90% confident that in our sample, the average number of chips is between 3.7 and 17.2.
...
41. A 90% CI for the average number of chocolate chips in a Chips Ahoy cookie:  
[3.9 chips, $\infty$)  
What is the correct interpretation?
     ...
     (c) We are 90% confident that in our sample, the average number of chips is bigger than 3.9.
     (d) In many repeated samples, 90% of sample averages will be bigger than 3.9
     (e) In many repeated samples, 90% of intervals like this one will contain the true average number of chips. 

[^41]: (e) In many repeated samples, 90% of intervals like this one will contain the true average number of chips.

---


42. Consider a Bayesian posterior interval for $\mu$ of the form: $\overline{X} \pm t^*_{n-1} s / \sqrt{n}$  
What was the prior on $\mu$?
    (a) N(0,0)
    (b) N($\overline{X}$,0)
    (c) N(0, 1/0)
    (d) N($\overline{X}$,1/0)
